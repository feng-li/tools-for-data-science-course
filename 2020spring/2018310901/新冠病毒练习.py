...
if __name__ == "__main__":
    ...
    with open("D:/Learning materials/tools-for-data-science-course/课件/code (2)/xinguan",encoding='UTF-8') as f:
        for line in f:
...
outputpath='D:/Computer Tools/Jupyter Notebook/新冠病毒练习.csv'
